...
Route::get('/sales/software/list', [SaleController::class, 'softwareDetails']);
Route::get('/sales/website/list', [SaleController::class, 'websiteDetails']);
...
Route::get('/unique/code', [FunctionController::class, 'UniqueCode']);